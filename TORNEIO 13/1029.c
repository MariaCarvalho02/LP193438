...
Aprendizado : Aprendi a utilizar funções recursivas, vetores e
               repetição para resolver problemas matemáticos.
Pergunta de segunda ordem: Por que o Fibonacci não começa em 2?
-------------------------------------------------------------------------- */
