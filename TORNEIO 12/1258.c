...
Data        : 21/05/2026
Objetivo    : Ler os dados das camisetas, armazená-los em uma struct e ordenar conforme os critérios definidos pelo problema (cor, tamanho e nome).
Aprendizado : Aprendi a utilizar structs para organizar dados, aplicar ordenação com qsort() e criar uma função de comparação commúltiplos critérios usando strcmp().
-------------------------------------------------------------------------- */
